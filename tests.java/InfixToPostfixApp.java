...
for(int i=0;i<infix.length();++i) //while there is input to be read{a+b*(c-d)}
{
...
else //print operators occurring before it that havegreater precedence
{
...
//Data Structure Using JAVA Lab Manual School of CS&E, REVA University24
System.exit(0);
 }
 else
 a[++top] = c;
